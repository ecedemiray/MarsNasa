...
namespace MarsNasaSolution.Service
{
    public class MarsNasaSolutionService : IMarsNasaSolutionService
    {
        /// <summary>
        /// rover movement
        /// </summary>
        ...
        /// <returns></returns>
        public Coordinates MoveRover(string[] maxPoints, string[] currentLocation, string movement, Invoker _invoker)
        {
